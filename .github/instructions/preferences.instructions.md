...
- Apply the JavaScript SonarQube profile "Sonar way-EXP" as the project coding-standard baseline, with the repository copy documented in `SonarQubeProfile.md`.
...
- 2026-04-07: Adopted SonarQube JavaScript profile "Sonar way-EXP" as repository coding-standard baseline, documented in `SonarQubeProfile.md`, with merge-blocking severity policy for Blocker/Critical findings and explicit enforcement of profile thresholds (S101, S107, S1479, S2004, S3776).
